const Footer = () => {
      ...
      <footer
        ...
        <div
          ...
          <div className="flex justify-center">
            ...
            <a href="https://www.linkedin.com/in/gaston-santos-654748227/" class="me-6 [&>svg]:h-4 [&>svg]:w-4">
              <svg
            ...
            <a href="https://github.com/gastonsantos" class="[&>svg]:h-4 [&>svg]:w-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 496 512">
  ...
  <a href="https://github.com/gastonsantos" className="ml-2 text-blue-500">https://github.com/gastonsantos</a>
</p>
        ...
        <div className="bg-black/5 p-6 text-center">
          <span>© 2023 Aplicación creada por:</span>
