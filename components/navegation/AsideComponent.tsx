      ...
      <aside className="bg-gray-800 text-white w-1/4 hidden md:block">
        <div className="p-4">
          ...
          <ul className="mt-4 space-y-2">
            <li><a href="/pages/perfil" className="block px-4 py-2 text-sm hover:bg-gray-700">Profile</a></li>
            <li><a href="/pages/perfil/futbol" className="block px-4 py-2 text-sm hover:bg-gray-700">Futbol</a></li>
