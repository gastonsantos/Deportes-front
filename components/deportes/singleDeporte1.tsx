                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-2xl xl:w-96 lg:w-96 md:w-1/2 sm:w-1/2 ">
                        ...
                        <div className="p-6">
                            ...
                            <Link href={`/pages/deportes/${idEvento}`} className="flex justify-center">
                                <button type="button" className="text-white bg-purple-600 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 ">Ver más</button>
                            </Link>
