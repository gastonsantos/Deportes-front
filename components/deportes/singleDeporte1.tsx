...
const SingleDeporte = ({ evento }: { evento: Evento }) => {
    const { idEvento, nombre, imagen, nombreDep, cantJugadores, provincia, localidad, direccion, numero, fecha, hora, idUsusarioDuenio } = evento;
    ...
    return (
        <div className="transform transition duration-300 hover:scale-105">
            ...
            <div className="antialiased text-gray-900 ">
                <div className="bg-transparent min-h-96 min-w-full p-8 flex items-center justify-center">
