...
export default function ModalCancelarParticipacion({ setShowModalCancelarParticipacion, handleRechazar, idParticipante }) {
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full text-white bg-gray-900 outline-none focus:outline-none">
                        ...
                        <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                            ...
                            <button
                                ...
                                onClick={() => setShowModalCancelarParticipacion(false)}
                            >
                        ...
                        <div className="relative p-6 flex-auto">
                            <p className="my-4  text-lg leading-relaxed">
                                ¿Estás seguro que deseas cancelar tu participación al  evento?
                            </p>
                        </div>
                        {/*footer*/}
                        <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                            ...
                            <button
                                ...
                                type="button"
                                onClick={() => {
                                    setShowModalCancelarParticipacion(false);
