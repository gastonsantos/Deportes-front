                    ...
                    <div className="bg-gray-900 rounded-lg " style={{ backgroundImage: `url('/images/Fondo1.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                        ...
                        <div className="flex items-center justify-between p-4">
                            ...
                            <div className="flex items-center p-2">
                                ...
                                <div className="ml-4 ">
                                    <h3 className="text-lg font-medium bg-amber-700 rounded-e-full pl-6 pr-6 pt-1 pb-1">{player.name}</h3>
                                    <p className="text-white-500 mt-2">{player.position}</p>
                                </div>
                            </div>
                            <div className="flex items-center justify-center font-bold text-lg text-white-500 mr-8 bg-amber-700 w-12 h-12 rounded-full -mt-10">{player.media}</div>


                        </div>
                        <div className="grid grid-cols-2 gap-4 p-5 ml-28 flex items-center justify-center">
                            ...
                            <div className="relative mt-1 flex items-center">
                                <Image src="/images/altura.png" alt="Imagen del jugador" width={32} height={32} className="mr-2" />
                                <span className="font-bold">{player.altura} cm</span>
                            </div>
                            <div className="relative mt-1 flex items-center">
                                <Image src="/images/pie.png" alt="Imagen del jugador" width={32} height={32} className="mr-2" />
                        ...
                        <div className="grid grid-cols-2 gap-4 p-4 mt-2">
                            <div className="relative">
                                ...
                                <span className="inline-block w-full h-4 bg-white rounded-md relative p-3">
